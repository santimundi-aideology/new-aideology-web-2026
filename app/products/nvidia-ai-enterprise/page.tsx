  ...
  return (
    <ProductLayout>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                Discover how NVIDIA AI Enterprise accelerates your AI development and deployment with enterprise-grade software and tools
              </p>
            </div>
            ...
            <div className="relative w-full max-w-5xl mx-auto animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-gray-900">
                <video
                  ...
                  controls
                  preload="metadata"
                  poster="/ai-enterprise-video-thumbnail.webp"
                >
                  <source src="/ai-enterprise-video.mp4" type="video/mp4" />
      ...
      <section className="mb-16 animate-fade-in-up">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-12 text-center text-charcoal pt-16">Core Components of NVIDIA AI Enterprise</h2>
