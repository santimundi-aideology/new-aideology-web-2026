  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-charcoal mb-4">AI Agent Capabilities</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 p-8 rounded-xl mb-16">
              <div className="flex items-start">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-charcoal mb-4">Transform Operations with AI Agents</h2>
            </div>
