    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              <div className="grid lg:grid-cols-2">
                <div className="p-12">
                  <h2 className="text-3xl font-bold text-charcoal mb-6">See It In Action</h2>
                  ...
                  <Button className="mt-8 bg-accent-green hover:bg-accent-green/90 text-charcoal font-semibold">
                    Try Interactive Demo
                  </Button>
                </div>

                <div className="bg-gradient-to-br from-charcoal to-gray-800 p-12 flex items-center">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
              <div className="grid lg:grid-cols-3 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4">NVIDIA Riva Platform</h3>
      ...
      <section className="py-20 bg-charcoal text-white">
        <div className="w-full px-6 lg:px-12 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Transform Customer Conversations?</h2>
