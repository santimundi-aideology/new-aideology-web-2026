...
export default function WhyAIdeologySection() {
  const kpis = [
    ...
    {
      value: "2–3 mo",
      label: "average time from kickoff to production",
      color: "bg-accent-green/20 border-accent-green/40",
    },
    {
      value: "20+",
      label: "years in the NVIDIA ecosystem",
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="animate-fade-in-up">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-charcoal">
                You Have the Compute.<br />We Make It Work.
              </h2>
              <div className="space-y-3 lg:space-y-4 text-gray-600">
                <p className="text-base lg:text-lg">
                  Enterprises and sovereign programs across the region have invested heavily in GPU clusters and AI
                  infrastructure. The real gap is no longer access to compute — it is turning that investment into
                  operating AI systems that deliver business outcomes.
                </p>
                <p className="text-base lg:text-lg">
                  AIdeology bridges that gap. From use-case selection and architecture decisions to agent deployment,
                  governance, and production scale — we take you from hardware to results.
                </p>
                <p className="text-base lg:text-lg">
                  Backed by 20+ years in the NVIDIA ecosystem and proven execution across large enterprise and sovereign
                  AI programs, we know the stack you bought and how to make it deliver.
                </p>
              </div>
            </div>
              ...
              {kpis.map((kpi, index) => (
                ...
                >
                  <CardContent className="p-4 lg:p-6 text-center">
                    <div className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 text-accent-green">{kpi.value}</div>
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow-lg w-full hover:shadow-xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 cursor-pointer">
                ...
                <p className="text-gray-700 text-sm lg:text-base mb-4">
                  We understand the AI stack at the deepest level — architecture, compute, sovereign deployment, and
                  production-grade execution. Our NVIDIA Elite status reflects 20+ years of hands-on expertise, not
                  just a badge.
                </p>
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '500ms' }}>
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow-lg w-full hover:shadow-xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 cursor-pointer">
                ...
                <p className="text-gray-700 text-sm lg:text-base mb-3">
                  Regional scale, ecosystem strength, and enterprise access across the Middle East, Africa, Europe,
                  and Central and Eastern Europe — giving AIdeology the reach to operate at national and
                  enterprise scale.
                </p>
              </div>
            </div>
