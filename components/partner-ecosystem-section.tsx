        ...
        <div className="text-center max-w-4xl mx-auto">
           ...
           <p className="text-lg text-charcoal/70 mb-12 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            generative AI, and 3D technologies
                 ...
                 {/* NVIDIA Logo Section */}
         <div className="flex flex-col items-center mb-16 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          <Link
            href="https://www.nvidia.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white border-2 border-gray-200 p-8 rounded-lg shadow-lg flex justify-center items-center min-h-[180px] w-[330px] hover:border-accent-green/50 hover:shadow-xl transition-all duration-300 hover:scale-105 group no-image-hover mb-4"
          >
            <img
              src="/partner-logos/nvidia-logo.webp"
              alt="NVIDIA logo"
              className="h-30 w-auto object-contain opacity-90 group-hover:opacity-100 transition-opacity duration-300"
            />
          </Link>
