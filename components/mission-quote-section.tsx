      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative animate-fade-in-up" style={{animationDelay: '200ms'}}>
            ...
            <blockquote className="text-2xl md:text-3xl lg:text-4xl font-montserrat font-light italic text-center px-8 text-white">
              "We may hope that machines will eventually compete with men in all purely intellectual fields."
            </blockquote>
            <div className="text-right mt-4 text-white/70 animate-fade-in-up" style={{animationDelay: '400ms'}}>
