export const partnerCategories = [
  ...
  { id: "design-simulation", name: "Design & Simulation" }, // Changed from 3d-ai
]
...
const partners = [
  // Design & Simulation Partners (formerly 3D AI)
  {
    name: "Meta",
    logo: "/partner-logos/meta-logo.webp",
    categories: ["design-simulation"],
    website: "https://about.meta.com/",
  },
  {
    name: "Autodesk",
    logo: "/partner-logos/autodesk-logo.webp",
    categories: ["design-simulation"],
    website: "https://www.autodesk.com/",
  },
  {
    name: "Unity",
    logo: "/partner-logos/unity-logo.webp",
    categories: ["design-simulation"],
    website: "https://unity.com/",
  },
  {
    name: "Unreal Engine",
    logo: "/partner-logos/unreal-logo.webp",
    categories: ["design-simulation"],
  ...
  {
    name: "Cerebras",
    logo: "/partner-logos/cerebras-logo.webp",
    categories: ["infra-ai"],
  ...
  {
    name: "VAST",
    logo: "/partner-logos/vast_logo.webp",
    categories: ["infra-ai"],
  ...
  {
    name: "Run:ai",
    logo: "/partner-logos/runai-logo.webp",
    categories: ["infra-ai", "gen-ai"],
    website: "https://www.run.ai/",
  },
  {
    name: "Weights & Biases",
    logo: "/partner-logos/wandb-logo.webp",
    categories: ["infra-ai", "gen-ai"],
